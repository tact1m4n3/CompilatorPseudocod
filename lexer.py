...
class Lexer(object):
    ...
    def tokenize(self):
        ...
        while self.current_char is not None:
            if self.current_char in " \t":
                ...
                tokens.append(Token(NEWLINE, _position_start=self.position.copy()))
                self.advance()
                ...
                tokens.append(Token(MUL, _position_start=self.position.copy()))
                self.advance()
            elif self.current_char == "/":
                tokens.append(Token(DIV, _position_start=self.position.copy()))
                self.advance()
            elif self.current_char == ",":
    ...
    def make_minus(self):
        ...
        return Token(MINUS, _position_start=position_start)
    ...
    def make_equals(self):
        ...
        if self.current_char == "=":
            self.advance()
            return Token(DOUBLE_EQUALS, _position_start=position_start, _position_end=self.position.copy())

        return Token(EQUALS, _position_start=position_start)
    ...
    def make_not_equals(self):
        ...
        if self.current_char == "=":
            self.advance()
            return Token(NOT_EQUALS, _position_start=position_start, _position_end=self.position.copy())
    ...
    def make_less_than(self):
        ...
        if self.current_char == "=":
            self.advance()
            return Token(LTOREQ, _position_start=position_start, _position_end=self.position.copy())
        elif self.current_char == "-":
            self.advance()
            return Token(BACKWORD_ARROW, _position_start=position_start, _position_end=self.position.copy())
        return Token(LT, _position_start=position_start)
    ...
    def make_greater_than(self):
        ...
        if self.current_char == "=":
            self.advance()
            return Token(GTOREQ, _position_start=position_start, _position_end=self.position.copy())
        return Token(GT, _position_start=position_start)
